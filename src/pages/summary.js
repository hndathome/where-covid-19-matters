                ...
                <main role="main">
                    <section className="jumbotron text-center">
                        <div className="container">
                            ...
                            <p className="lead text-muted">&#34;Covid-19 Testing Locations&#34; is sourced from <strong><em><a href="https://developer.here.com/blog/finding-covid-19-testing-sites">HERE Geocoding and Search API</a></em></strong>.</p>
                            <p className="lead text-muted">State Health Department links are provided by <strong><em><a href="https://covidtracking.com/data/api">The COVID Tracking Project</a></em></strong>.</p>
                        </div>
                    </section>
