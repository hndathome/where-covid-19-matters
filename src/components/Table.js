...
function Table(props) {
    ...
    return (
        <table className="table table-striped table-sm" data={currentUSValues}>
            ...
            <tbody>
                <tr><td>Positives</td><td>{currentUSValues.positive && currentUSValues.positive.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}</td><td><FontAwesomeIcon className={currentUSValues.positiveIncrease > 0 ? "increaseGreen" : "decreaseRed"} icon={currentUSValues.positiveIncrease > 0 ? faCaretUp : faCaretDown} aria-label="decrease or increase positive cases" /> {currentUSValues.positiveIncrease && currentUSValues.positiveIncrease.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}</td></tr>
                <tr><td>Hospitalizations</td><td>{currentUSValues.hospitalized && currentUSValues.hospitalized.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}</td><td><FontAwesomeIcon className={currentUSValues.hospitalizedIncrease > 0 ? "increaseGreen" : "decreaseRed"} icon={currentUSValues.hospitalized > 0 ? faCaretUp : faCaretDown} aria-label="decrease or increase hospitalizations" /> {currentUSValues.hospitalizedIncrease && currentUSValues.hospitalizedIncrease.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}</td></tr>
                <tr><td>Deaths</td><td>{currentUSValues.death && currentUSValues.death.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}</td><td><FontAwesomeIcon className={currentUSValues.deathIncrease > 0 ? "increaseGreen" : "decreaseRed"} icon={currentUSValues.deathIncrease > 0 ? faCaretUp : faCaretDown} aria-label="decrease or increase deaths" /> {currentUSValues.deathIncrease && currentUSValues.deathIncrease.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}</td></tr>
            </tbody>
        </table>
    )
}
